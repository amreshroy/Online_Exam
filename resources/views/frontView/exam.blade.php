...
<div class="main">
    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tr> 
            <td>  <input type="radio" value="#"> {{ $q->Option1 }} </td>
          </tr>

          <tr>
            <td> <input type="radio" value="#"> {{ $q->Option2 }} </td>
          </tr>

          <tr>
            <td> <input type="radio" value="#"> {{ $q->Option3 }} </td>
          </tr>

          <tr>
            <td> <input type="radio" value="#"> {{ $q->Option4 }} </td>
          </tr><br>
          <tr>
